    ...
    try:
        ...
        try:
            ...
            with transaction.atomic():
                ...
                t = Transaction.objects.create(account = selected_account, amount = input_amount, endBalance = selected_account.balance)
        
        
                return HttpResponseRedirect(reverse('transactions:results', args = (selected_account.id,)))
